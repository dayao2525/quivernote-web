...
declare class Vditor {
    ...
    static highlightRender: (hljsOption?: import("../types/index").IHljs, element?: HTMLElement | Document, cdn?: string) => void;
    /** 对数学公式进行渲染 */
    static mathRender: (element: HTMLElement, options?: {
        cdn?: string;
        math?: import("../types/index").IMath;
    }) => void;
    /** 流程图/时序图/甘特图渲染 */
    ...
    /** 大纲渲染 */
    static outlineRender: (contentElement: HTMLElement, targetElement: Element, vditor?: import("../types/index").IVditor) => string;
    ...
    static md2html: (mdText: string, options?: import("../types/index").IPreviewOptions) => Promise<any>;
    /** 页面 Markdown 文章渲染 */
    static preview: (previewElement: HTMLDivElement, markdown: string, options?: import("../types/index").IPreviewOptions) => Promise<void>;
    /** 设置代码主题 */
